...
function displayDialog(myObjectList){
	...
	myWindow.alignChildren = "top";
		...
		//dialog functions
		slideH31.onChanging = function () {tr41.text = slideH31.value + "%";} //devision
		slideV32.onChanging = function () {tr42.text = slideV32.value + "%";} //devision
		slideH51.onChanging = function () {tr61.text = this.value + "%"; tr62.text = this.value + "%"; slideV52.value = this.value;} //shift
		slideV52.onChanging = function () {tr62.text = this.value + "%"; tr61.text = this.value + "%"; slideH51.value = this.value;} //shift
		...
		*/
		...
		hmax.onChanging = function(){reverse()}
		hmin.onChanging = function(){reverse()}
		vmax.onChanging = function(){reverse()}
		vmin.onChanging = function(){reverse()}
